    ...
    <ScrollView style={styles.container}>
      <View style={styles.imagesContainer}>
        <ScrollView horizontal pagingEnabled>
          {orphanage.images.map(element => {
            return <Image style={styles.image} key={element.id} source={{ uri: element.url }} />
          })}
        </ScrollView>
      </View>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={toGoogleMaps} style={styles.routesContainer}>
        ...
        <View style={styles.scheduleContainer}>
          ...
          {orphanage.open_on_weekends ? (
            ...
            <View style={[styles.scheduleItem, styles.scheduleItemRed]}>
              ...
              <Text style={[styles.scheduleText, styles.scheduleTextRed]}>Close on weekends</Text>
            </View>
          )}
        </View>
